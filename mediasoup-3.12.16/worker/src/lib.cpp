  ...
  PayloadChannelWriteCtx payloadChannelWriteCtx)
{
	...
	MS_DEBUG_TAG(info, "starting mediasoup-worker process [version:%s] [consumerChannelFd: %d], [producerChannelFd: %d], [payloadConsumeChannelFd: %d], [payloadProduceChannelFd: %d]", version, consumerChannelFd, producerChannelFd, payloadConsumeChannelFd, payloadProduceChannelFd);
